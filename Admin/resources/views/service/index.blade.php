...
@section('content')
    @component('layouts.components.breadcrumb')
        @slot('breadcrumb_title')
            <h3>مدیریت خدمات</h3>
        @endslot
        <li class="breadcrumb-item active">مدیریت خدمات</li>
    @endcomponent
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">مدیریت خدمات</h4>
            </div><!--end card-header-->
            <div class="card-body">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#delete-item" oncontextmenu="return false" data-action="{{route('service.delete',$item->id)}}"
